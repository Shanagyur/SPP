package hu.uni.miskolc.iit.ssp.doc;
...
import hu.uni.miskolc.iit.ssp.doc.convert.DocConverterFactory;

public class ScientificPaperDocBuilderIT {
	...
	private ScientificPaperDocBuilder builder;
	...
	public void setUp() throws Exception {
		try {
			factory = new DocConverterFactory(System.getProperty("os.name"));
			converter = factory.createDocPDFConverter(goodFile);
			builder = new ScientificPaperDocBuilder(converter);
	...
	private void initFields(File file) throws NoMainDocumentFoundException, IOException {
		builder.checkFileExtension(file);
	}
	...
	public void extractTitle_emptyTitle() throws NoMainDocumentFoundException, IOException {
		...
		String actual = builder.extractTitle(goodFileWithEmptyItems);
